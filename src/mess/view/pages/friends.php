...
<main>
    <div class="container">
        <?php foreach ($this->friends as $friend): ?>
            <div class="row bg-light mb-4  d-flex align-items-center" id="friend">
                <div class="col-2 col-sm-2 col-md-2 col-lg-1 col-xl-3">
                    <div id="image">
                        <img src="<?= htmlSpecialChars($friend->avatarUrl()); ?>" alt="avatar">
                    </div>
                </div>
                <div class="col-4 col-sm-4 col-md-4 col-lg-7 col-xl-5">
                    <div id="userName" class="text-dark">
                        <span><?= htmlSpecialChars($friend->firstName); ?></span>
                        <span><?= htmlSpecialChars($friend->lastName); ?></span>
                    </div>
                </div>
                <?php if (!$this->areFriends): ?>
                    <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                        <form action="" method="post">
                            <input type="hidden" name="friend" value="<?= htmlSpecialChars($friend->userId); ?>"/>
                            <input type="submit" name="deleteAccount" value="Usuń" class="btn btn-dark"/>
                        </form>
                    </div>
                <?php endif; ?>
                <div class="col-2 col-xl-1">
                    <a href="<?= htmlEntities($friend->profileUrl()); ?>">
