...
<main>
    <div class="container mt-5">
        <?php foreach ($this->search as $search): ?>
            <div class="row mb-4 bg-light  d-flex align-items-center">
                <div class="col-2 col-sm-2 col-md-2 col-lg-1 col-xl-3">
                    <div>
                        <img src="<?= htmlSpecialChars($search->avatarUrl()); ?>" height="60px" width="60px">
                    </div>
                </div>
                <div class="col-4 col-sm-4 col-md-4 col-lg-7 col-xl-5">
                    <div class="text-dark">
                        <div class="xyz font-weight-bold mr-1"><?= htmlSpecialChars($search->firstName); ?></div>
                        <div class="fgh font-weight-bold"><?= htmlSpecialChars($search->lastName); ?></div>
                    </div>
                </div>
                <div class="col-2 col-xl-1">
                    <a href="<?= htmlEntities($search->profileUrl()); ?>">
