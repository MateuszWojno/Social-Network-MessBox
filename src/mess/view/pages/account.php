...
<head>
    ...
    <link rel="stylesheet" href="assets/style/account.css" type="text/css">
...
<nav class="navbar  navbar-expand-xl" id="menu">
    ...
    <div class="collapse navbar-collapse" id="mainmenu">
        ...
        <ul class="navbar-nav ml-auto nav-flex-icons col-xl-3 bg-f1  d-flex justify-content-end">
            <li class="nav-item dropdown mr-2" id="panelMenu">
...
<main class="d-flex justify-content-center">
    <div class="container">
        <div class="row d-flex justify-content-center" id="deleteAccount">
            <h2 class="text-light">Usuwanie konta</h2>
        </div>
        <div class="row d-flex justify-content-center mt-4">
            <form method="post">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <button type="submit" class="btn btn-danger mb-3" name="deleteAccount">Usuń konto</button>
                </div>
            </form>
        </div>
    </div>
