...
<div class="container-fluid" id="startingPage">
    <div class="row">
        <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6" id="image">
            <img src="assets/social-media.jpg" class="responsive" width="600" height="400" alt="Girl in a jacket">
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-66 d-flex justify-content-center d-flex flex-wrap align-content-center"
             id="first">
            <div>
                <h1 class="text-light flex align-items-center">
                    NAWIĄŻ KONTAKTY Z MILIONAMI LUDZI NA CAŁYM ŚWIECIE
                </h1>
                <div class="text-light flex align-items-center">
                    <h2 style="color:blue">ZACZNIJ JUŻ DZIŚ</h2>
                </div>
            </div>
        </div>
    </div>
